...
heroImage: '../../../../content/post/2026/01-03-nextjs-server-actions-fastapi-openapi/_images/architecture-diagram-todo.png'
heroAlt: Next.js, FastAPI interaction, architecture diagram
tags:
  - next.js
  - react
  - fastapi
...
import ArchitectureDiagramTodoImage from '../../../../content/post/2026/01-03-nextjs-server-actions-fastapi-openapi/_images/architecture-diagram-todo.png'
...
<Image {...IMAGE_SIZES.FIXED.MDX_MD} src={ArchitectureDiagramTodoImage} alt="Architecture diagram, client JavaScript, Next.js server and FastAPI server" />
...
// long to read, long to write and figure out
