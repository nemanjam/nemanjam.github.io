...
[frontend/apps/web/src/app/api/client-proxy/[...path]/route.ts](https://github.com/nemanjam/full-stack-fastapi-template-nextjs/blob/main/frontend/apps/web/src/app/api/client-proxy/%5B...path%5D/route.ts)

```ts title="frontend/apps/web/src/app/api/client-proxy/[...path]/route.ts"
...
[frontend/apps/web/src/app/page.tsx](https://github.com/nemanjam/full-stack-fastapi-template-nextjs/blob/main/frontend/apps/web/src/app/page.tsx)

```ts title="frontend/apps/web/src/app/page.tsx"
'use client';
