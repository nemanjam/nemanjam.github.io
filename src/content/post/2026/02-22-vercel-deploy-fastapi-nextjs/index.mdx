...
heroImage: '../../../../content/post/2026/02-22-vercel-deploy-fastapi-nextjs/_images/todo-hero-16-8.png'
heroAlt: FastAPI and Next.js deployment architecture on Vercel
tags:
  - fastapi
  - next.js
  - devops
...
- Vercel supported runtimes https://vercel.com/docs/functions/runtimes
- Vercel supported backend frameworks https://vercel.com/docs/frameworks/backend/fastapi
