...
heroAlt: bash backup mysql docker rsync illustration
tags:
  - devops
  - self-hosting
category: showcases
...
# Per job
30 23 * * * TZ=Europe/Belgrade cd /home/username/traefik-proxy/apps/mybb/backup/scripts && /usr/bin/bash ./run-backup-files-and-mysql.sh
30 23 * * * CRON_TZ=Europe/Belgrade cd /home/username/traefik-proxy/apps/mybb/backup/scripts && /usr/bin/bash ./run-backup-files-and-mysql.sh
```

// Todo:
        overview explanation in detail
        remote, local explanation
        analyze log and files
        hero screenshot
        relative paths
...
## Room for improvements
        ...
        // var include assets
        // env file
        // decentralized, upload remote script
        // simulate testing over time
        // cron time zone
// enforce non-interactive ssh connections // no
...
- **Example app:** https://github.com/nemanjam/mybb-docker

## Conclusion

// no point building whole backup solution
