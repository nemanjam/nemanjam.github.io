...
I decided to fully customize it to fit my needs and preferences, **so I rewrote the frontend from scratch using Next.js v16** with Server Components and Server Actions, along with Shadcn UI, Tailwind CSS v4, and a Turborepo monorepo setup. To enable SSR, I modified the backend to use an HttpOnly authentication cookie.
